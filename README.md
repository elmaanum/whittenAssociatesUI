# Whitten Associates UI
This is the new and improved version of the Whitten Associates website
...
```bash
git clone https://github.com/elmaanum/whittenAssociatesUI.git
